...
export function HomePage() {
  ...
  return <>
    ...
    <section className="legal-clarity section-dark">
      <div className="shell legal-clarity-grid">
        <div className="legal-image reveal">
          <img src="/images/unnamed (15).webp" alt="Vehículo con lunas traseras tintadas y ventanillas delanteras transparentes" loading="lazy"/>
    ...
    <section className="company-teaser">
      <div className="company-teaser-image"><img src="/images/workshop.jpg" alt="Interior del taller Solarcheck Lleida" loading="lazy"/><span>EL CENTRO · LLEIDA</span></div>
...
export function ServicesPage() {
  ...
  return <>
    ...
    <PageHero eyebrow="SERVICIOS SOLARCHECK LLEIDA" title="Protección pensada para" highlight="cada superficie." text="Del cristal de tu coche a la fachada de tu negocio. Tres especialidades, una misma obsesión: elegir bien, instalar mejor y dejar un acabado impecable." image="/images/stock/installer-precision.jpg" imageAlt="Profesionales preparando una película de protección en un taller" objectPosition="center 44%">
  ...
  return <>
    ...
    <section className="legal-panel section-dark">
      <div className="shell legal-panel-grid">
        ...
        <div className="glass-map reveal"><div className="glass-map-car"><img src="/images/unnamed (15).webp" alt="Vehículo con lunas traseras tintadas y delanteras transparentes"/><div className="glass-map-hot rear">Permitido<span>Laterales traseras<br/>y luneta</span></div><div className="glass-map-hot front">No ordinario<span>Parabrisas y<br/>laterales delanteras</span></div></div><div className="glass-legend"><span><i className="allow"/> Zona de instalación habitual</span><span><i className="deny"/> Campo de visión del conductor</span></div></div>
      </div>
    </section>
...
export function PpfPage() {
  ...
  return <>
    ...
    <CtaBand title="¿Qué parte de tu coche te preocupa más?" text="Dinos modelo, año y tipo de uso. Te ayudaremos a decidir entre zonas críticas, frontal o cobertura integral." source="protección PPF para mi coche" image="/images/stock/ppf-installation.jpg"/>
  </>;
}
